...
class QuizManager {
    ...
    //Array de tuplas, que contem as questoes
   ...
   // Variaveis privadas para que nao possam ser acessadas fora da classe
    private var quiz: Quiz!
    private var _totalAnswers = 0
    private var _totalCorrectAnswers = 0
    
    
    //variaveis computadas para que o quiz possa somente consultar os dados 
    var question: String {
...
}// Classe responsavel por toda a gerencia do quiz
// por esta classe sera possivel validar as questoes
